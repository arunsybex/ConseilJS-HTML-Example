...
async function transferUte(payload) {
    ...
    try {
        ...
        const uteResult = await conseiljs.TezosConseilClient.awaitOperationConfirmation(conseilServerConfig, conseilServerConfig.network, clearRPCOperationGroupHash(uteOpId), 11, networkWait);
